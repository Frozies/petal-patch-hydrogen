          ...
          */}
            <div className="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
              ...
              Leaving: "transition-opacity ease-linear duration-300"
                ...
                To: "opacity-0"
            */}
              {/*<div className="fixed inset-0 bg-black bg-opacity-25" aria-hidden="true"></div>*/} {/*OVERLAY*/}
                      ...
                      <div className="space-y-6">
                        <div className="flex items-center">
                          <input id="filter-mobile-category-0" name="category[]" value="new-arrivals" type="checkbox"
                                 className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                          <label htmlFor="filter-mobile-category-0" className="ml-3 min-w-0 flex-1 text-gray-500"> New
                            Arrivals </label>
                        </div>
                ...
                <div className="flex items-center">
                  ...
                  */}
                    <div
                      ...
                      */}
                        <a href="#" className="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem"
                           tabIndex={-1} id="menu-item-0"> Most Popular </a>

                        <a href="#" className="text-gray-500 block px-4 py-2 text-sm" role="menuitem" tabIndex={-1}
                  ...
                  <form className="hidden lg:block">
                    ...
                    */}
                      ...
                      <div className="pt-6" id="filter-section-0">
                        <div className="space-y-4">
                          <div className="flex items-center">
                            <input id="filter-color-0" name="color[]" value="blue" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-0" className="ml-3 text-sm text-gray-600"> Blue </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-1" name="color[]" value="green" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-1" className="ml-3 text-sm text-gray-600"> Green </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-2" name="color[]" value="orange" type="checkbox" checked
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-2" className="ml-3 text-sm text-gray-600"> Orange </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-3" name="color[]" value="pink" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-3" className="ml-3 text-sm text-gray-600"> Pink </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-4" name="color[]" value="purple" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-4" className="ml-3 text-sm text-gray-600"> Purple </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-5" name="color[]" value="red" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-5" className="ml-3 text-sm text-gray-600"> Red </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-5" name="color[]" value="white" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-5" className="ml-3 text-sm text-gray-600"> White </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-5" name="color[]" value="yellow" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-5" className="ml-3 text-sm text-gray-600"> Yellow </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-color-5" name="color[]" value="colorful" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-color-5" className="ml-3 text-sm text-gray-600"> Colorful </label>
                          </div>
                    ...
                    */}
                      ...
                      <div className="pt-6" id="filter-section-1">
                        <div className="space-y-4">
                          <div className="flex items-center">
                            <input id="filter-category-0" name="holiday[]" value="mothers-day" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-600"> Mother's Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-1" name="holiday[]" value="valentines-day" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-1" className="ml-3 text-sm text-gray-600"> Valentines Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-2" name="holiday[]" value="st-patricks-day" type="checkbox" checked
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-2" className="ml-3 text-sm text-gray-600"> St. Patrick's Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-3" name="holiday[]" value="easter" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-3"
                                   className="ml-3 text-sm text-gray-600"> Easter </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="memorial-day" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Memorial Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="fathers-day" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Father's Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="independence-day" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Independence Day </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="halloween" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Halloween </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="thanks-giving" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Thanksgiving </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="hanukkah" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Hanukkah </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="christmas" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> Christmas </label>
                          </div>

                          <div className="flex items-center">
                            <input id="filter-category-4" name="holiday[]" value="new-years" type="checkbox"
                                   className="h-4 w-4 border-gray-300 rounded text-indigo-600 focus:ring-indigo-500"/>
                            <label htmlFor="filter-category-4"
                                   className="ml-3 text-sm text-gray-600"> New Years' Eve </label>
                          </div>
                        </div>
                      </div>
                    </div>
