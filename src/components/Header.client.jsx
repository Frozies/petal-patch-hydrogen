    ...
    if (width <= 1024)
      return (
        <>
            ...
            <div className="h-full w-full flex flex-row lg:flex-col place-content-around">
              ...
              hover:border-black/100"
                ...
                <CartToggle
                  ...
                  className={
                    'border-2 border-black/0 hover:border-black/100 flex flex-row items-center justify-around'
                  }
                />
              </div>
            </div>
          ...
          <div
            className={
              'relative z-35 h-12 w-full px-6 mx-auto border-b border-gray-200 bg-header-pink flex ' +
    ...
    if (width > 1024)
      return (
        <>
          ...
          <div
            className={
              'relative z-35 h-10 w-full px-6 mx-auto border-b border-gray-200  bg-header-pink xs:hidden md:block'
            }
          >
