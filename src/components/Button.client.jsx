...
const DEFAULT_CLASSES =
  '-z-50 block m-0 w-full items-center justify-center uppercase font-medium text-center px-6 py-4 rounded disabled:border-gray-300 disabled:bg-gray-300 disabled:cursor-not-allowed';

const VARIANT_CLASSES = {
  primary:
    'text-black border-2 border-header-blue hover:bg-gray-800 active:bg-gray-700',
  secondary:
    'bg-header-blue hover:bg-gray-50 active:bg-gray-100 border border-black',
};
